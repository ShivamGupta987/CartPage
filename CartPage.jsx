...
//             return {
//               ...cartItem,
//               quantity: cartItem.quantity + 1 // Increment quantity by 1
//             };
//           } else {
//             return cartItem;
//           }
...
//       setCartItems(updatedCart); // Update cartItems state with the updated array
...
//               // refetch is used for not refresh the page if delete the item if not refetch humlog ko hmesha refresh krna hoga br br delete krkne ke baad
//               refetch();
//               Swal.fire({
//                 title: "Deleted!",
...
// //       </div>
// //       {/* customer details */}
// //       <div className="my-12 flex flex-col md:flex-row justify-center gap-8">
